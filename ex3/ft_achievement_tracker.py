...
def main():
    ...
    print(f"Only Alice: {Alice.difference(Bob).difference(Charlie).difference(Dylan)}")
    print(f"Only Bob: {Bob.difference(Alice).difference(Charlie).difference(Dylan)}")
    print(f"Only Charlie: {Charlie.difference(Alice).difference(Bob).difference(Dylan)}")
    print(f"Only Dylan: {Dylan.difference(Alice).difference(Bob).difference(Charlie)}")
